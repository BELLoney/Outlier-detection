...
|  11| Monks |Chess_0_12_variant1|Downsampling the class "0" down to 12 objects| 0 | 6 | 240 | 12 |
|  12| Monks |Chess_0_25_variant1|Downsampling the class "0" down to 25 objects| 0 | 6 | 253 | 25 |
|  13| Mushroom|Mushroom_p_85_variant1|Downsampling the class ''+" down to 85 objects | 0|22|4293|85|
|  14| Mushroom|Mushroom_p_221_variant1|Downsampling the class ''+" down to 221 objects | 0|22|4429|221|
|  15| Mushroom|Mushroom_p_365_variant1|Downsampling the class ''+" down to 365 objects | 0|22|4573|365|
|  16| Mushroom|Mushroom_p_467_variant1|Downsampling the class ''+" down to 467 objects | 0|22|4675|467|
|  17| Mushroom|Mushroom_p_573_variant1|Downsampling the class ''+" down to 573 objects | 0|22|4781|573|
|  18| Nursery|Nursery_variant1|Classes "recommend" and "very_recom" are combined to form the outliers class and the rest of the classes are combined to form the inliers class| 0 | 8 | 12960 | 330 | 
|  19| Tic tac toe|Tic tac toe_negative_26_variant1|Downsampling the class "negative" down to 26 objects | 0|9|652|26|
|  20| Vote|Vote_republican_29_variant1|Downsampling the class "republican" down to 29 objects | 0|16|296|29|
|  21| Zoo|Zoo_variant1|Classes "reptile", "amphibian" and "insect" are combined to form the outliers class and the rest of the classes are combined to form the inliers class| 0|16|101|17|
